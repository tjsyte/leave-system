...
<div class="row">
    <div class="col-md-8">
        ...
        <?php if (mysqli_num_rows($balance_result) > 0): ?>
                    ...
                    <table class="table table-hover align-middle mb-0 leave-balance-enhanced" id="leaveBalanceTable">
                        ...
                        <tbody>
                            ...
                            <tr class="leave-row" data-status="<?php echo $status_class; ?>">
                                ...
                                <!-- Available -->
                                <td class="text-center">
                                    <div class="stat-number text-success fw-bold fs-5">
            ...
            <!-- Enhanced JavaScript for Table Functionality -->
            <script>
            ...
            function viewLeaveHistory(leaveType) {
                window.location.href = `my_leaves.php?filter=${encodeURIComponent(leaveType)}`;
            }
            </script>
        <?php else: ?>
